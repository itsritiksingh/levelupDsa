...
public class Main {
    ...
    //Insertion and Deletion time complexity of AVL tree is O(log n) and the searching time complexity of
    //the AVL tree is O(n) which makes it better than binary search tree and red-black tree.
